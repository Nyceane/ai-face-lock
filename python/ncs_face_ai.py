...
from ncscamera.video_source import *
from ncscamera.ncs_network import *
from ncscamera.ncs_video_sink import *
from ncscamera.gtk_output import *
from ncscamera.ncs_thread_model import *
...
if __name__=="__main__":
  ...
  sourcegroup.add_argument('--picture-src',
                           help="filename of input picture, e.g. ../../images/512_Ball.jpg")
